...
const Maindata = useSelector<Signupinterface,Signupinterface>(state=>state)
   ...
   if(fireuser!==null&&fireuser?.user?.email) {
                  ...
                  <div className="myform form ">
                     ...
                     <form onSubmit={handleSubmit(HandleSub)}>
                        <div className="form-group">
                           ...
                           <input type="text" ref={register({required:true})} name="email" className="form-control"
                        ...
                        <div className="form-group">
                           ...
                           <input type="password" name="password"
                              ref={register({required:true,minLength:8,maxLength:20})} id="password"
